...
export default async function ProfileSettingsPage() {
  ...
  return (
    // One centred column: the shell is 76rem, and a single form column left
    // against the gutter reads as a rendering mistake on a wide screen.
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-8 rounded-2xl border border-dashed border-line p-8">
          ...
          <p className="mt-3 text-body-sm text-fg-muted text-pretty">
            Your name on the sign-in screen, your password and your email
            address live with Clerk, not here. Open the avatar menu in the top
            right to change them. We pick up a new email address on your next
            visit.
          </p>
          <p className="mt-4 text-body-sm text-fg-subtle text-pretty">
            Deleting your account in Clerk now deletes your profile and every
            pairing request attached to it from our database too. See the{" "}
            <Link
              href="/privacy"
